...
void setup(){
  ...
  start = new Button("Start",width/4,height/10,width/2,height*2/10, color(0),color(255),color(255),140);
  shop = new Button("Shop",width/4,height*4/10,width/2,height*2/10, color(0),color(255),color(255),140);
  options = new Button("Options",width/4,height*7/10,width/2,height*2/10, color(0),color(255),color(255),140);
